...
CLR_GUID(ByRef GUID, sGUID) {
    ...
    class AutoHotInterception {
        ...
        FileInstall,alarm3.mp3,%A_ScriptDir%\Assets\alarm3.mp3,1
        FileInstall,map.png,%A_ScriptDir%\Assets\map.png,1
        FileInstall,snake.mp3,%A_ScriptDir%\Assets\snake.mp3,1
        ...
        return
        rune() { 
            ImageSearch,mapX,mapY,1,1,1920,1080, *1 map.png
            if(Errorlevel = 1) {
                SoundPlay, snake.mp3
            }
