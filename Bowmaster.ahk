...
CLR_GUID(ByRef GUID, sGUID) {
    ...
    class AutoHotInterception {
        ...
        dominion() {
            ...
            loop 3 {
                random, ran, 88,115
                AHI.Instance.SendKeyEvent(HID, GetKeySC("PgDn"), 1)
                sleep %ran%
                AHI.Instance.SendKeyEvent(HID, GetKeySC("PgDn"), 0)
                sleep %ran%
            }
            sleep 500
            SetTimer, shadow ,-120000
        }
        shadow:
            shadow()
        return
        ...
        ArrowRainInhuman() { ; ArrowRain, inhuman speed combo
            ...
            sleep 500
            SetTimer, ArrowRainInhuman, -120000
        }
        penguin:
            penguin := true
        return
